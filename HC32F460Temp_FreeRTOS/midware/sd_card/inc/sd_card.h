...
typedef struct stc_sdcard_init
{
    ...
    const stc_sdioc_init_t *pstcInitCfg;    ///< SD required parameters
                                            ///< and this stuctrue detail refer @ref stc_sdioc_init_t
} stc_sdcard_init_t;
...
typedef struct stc_sdcard_dma_init
{
    M4_DMA_TypeDef   *DMAx;                 ///< Pointer to DMA registers base address
                                            ///< and this stuctrue detail refer @ref M4_DMA_TypeDef
...
typedef struct stc_sd_handle
{
    M4_SDIOC_TypeDef             *SDIOCx;           ///< Pointer to SD registers base address
                                                    ///< and this stuctrue detail refer @ref M4_SDIOC_TypeDef
    ...
    const stc_sdcard_dma_init_t  *pstcDmaInitCfg;   ///< Pointer to SD Card initilization parameters
                                                    ///< and this stuctrue detail refer @ref stc_sdcard_init_t

    const stc_sdcard_init_t      *pstcCardInitCfg;  ///< Pointer to SD Card initilization parameters
                                                    ///< and this stuctrue detail refer @ref stc_sdcard_init_t
    ...
    stc_sd_card_info_t           stcSdCardInfo;     ///< SD Card information
                                                    ///< and this stuctrue detail refer @ref stc_sd_card_info_t

    stc_sdmmc_resp_card_status_t stcCardStatus;     ///< SD Card status
                                                    ///< and this stuctrue detail refer @ref stc_sdmmc_resp_card_status_t
